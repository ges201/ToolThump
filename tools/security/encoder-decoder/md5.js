...
/*
 * Calculate the MD5 of a UTF-8 string
 */
function hex_md5(s) {
    return rstr2hex(rstr_md5(str2rstr_utf8(s)));
}
 ...
 */
function raw_hmac_md5(key, data) {
...
function rstr2any(input, encoding) {
    ...
    /*
     * Repeatedly divide the dividend by divisor, and get the remainder.
     * Each time the remainder is a character in the encoding
     */
